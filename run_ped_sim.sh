...
if [ ! -f $dir/output_filtered.seg.gz ]; then
...
R -q -e "source('pedigree_2.R'); cor <- Analyze('${dir}/output-everyone.fam', '${dir}/output_filtered.seg.gz'); write.csv(cor, '${dir}/corr2.csv')"
